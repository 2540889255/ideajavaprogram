 ...
 * @author admin
 */
public class DemoSelectorServer2 extends Thread{
        ...
        try (
            ...
            while (true){
                ...
                logger.info(() -> {
                    ...
                    String s = null;
                    try {
                        s = "remoteaddr" + asynchronousSocketChannel.getRemoteAddress();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    return s;
                ...
                asynchronousSocketChannel.write(Charset.defaultCharset().encode("hello i am server"));
